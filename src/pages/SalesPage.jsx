...
export default function SalesPage() {
  ...
  const metricConfig = {
    ...
    orders: { label: "Orders", formatter: (value) => value.toLocaleString(), short: (value) => value.toLocaleString(), color: "var(--series-2)" },
